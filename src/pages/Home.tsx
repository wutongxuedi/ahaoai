        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-6">
              ...
              <Link to="/my-products" className="text-neutral-400 hover:text-neutral-200 transition-colors font-light">
                我在做的产品
              </Link>
              <Link to="/recommend-products" className="text-neutral-400 hover:text-neutral-200 transition-colors font-light">
                我推荐的产品
              </Link>
            </div>
          </div>
